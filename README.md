...
The Sirio IJV firmware supports the extension from 200 channels to 999 channels replacing the 64Kb EEPROM with a pin/logic compatible 128Kb [M24M01-RMN6TP](docs/M24M01-RMN6TP.pdf):

<div align="center">

![EEPROM chip](docs/M24M01-RMN6TP.png)

EEPROM I2C 1Mbit SOIC SMD 8 pin
