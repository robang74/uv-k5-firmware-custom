...
#V requires ROBANG74_UI_MENU enabled
ENABLE_FLOCK_SHORT_MENU         ?= 1
#V requires ROBANG74_UI_MENU enabled
ENABLE_SIXTH_CHARS_MENU         ?= 1 
#V real short? all  these 3 dsabled!
...
ifeq ($(ENABLE_SPRINTF_TYPE_CHECKING), 1)
    CFLAGS += -DENABLE_SPRINTF_TYPE_CHECKING
endif
...
ifeq ($(ENABLE_SIXTH_CHARS_MENU),1)
	CFLAGS += -DENABLE_SIXTH_CHARS_MENU
endif
ifeq ($(ENABLE_SPECTRUM),1)
